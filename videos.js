...
function truth(){
    ...
    <h1>Permanary</h1>
    <div class="vid2">
    <iframe width="100%" height="315" src="https://www.youtube.com/embed/RqDr8y6IPxk?si=yI3M7M7L_fi9MRf6" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    </div>
    </div>
    ...
    <div class="video">
    <h1>False Idol of Certainty</h1>
    <div class="vid2">
    <iframe width="100%" height="315" src="https://www.youtube.com/embed/YPdAfAQSCDc?si=ehCCSBbbfqI5HPFe" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    </div>
    </div>
    ...
    <h1>Dark Matter</h1>
    <div class="vid2">
    <iframe width="100%" height="315" src="https://www.youtube.com/embed/_299d5ZaXXY?si=YoTHQWkskVFagfYD" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    </div>
    </div>
...
function coding(){
    ...
    <div class="vid2">
    <iframe width="100%" height="315" src="https://www.youtube.com/embed/9YfSRRbZHQ4?si=--69_D4FFtRL6nmi" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    </div>
</div>

    <div class="video2">
    <h1>
        Shock Rifle (chain reaction explosions)
    </h1>
    <div class="vid2">
    <iframe width="100%" height="315" src="https://www.youtube.com/embed/G1wV5d4H7eI?si=n4Wb4LUkVUWsjrwq" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    </div>
</div>
...
<div class="video2">
    ...
    <p>Facebook Clone with Database</p>
        ...
        <div class="video">
        <h1>Dall.E</h1>
        <iframe width="100%" height="315" src="https://www.youtube.com/embed/pJ-CvVZ6r5c" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
...
function cod(){
    ...
    <div class="video">
        <h1>Good For You</h1>
        <div class="vid2">
            <iframe width="100%" height="315" src="https://www.youtube.com/embed/gbBMwbPnLxY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
    </div>
        <div class="video">
            <h1>The Joker</h1>
            <div class="vid2">
                <iframe width="100%" height="315" src="https://www.youtube.com/embed/uMdY8lS-_zY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
        <div class="video2">
            <h1>Deadpool</h1>
            <div class="vid2">
                <iframe width="100%" height="315" src="https://www.youtube.com/embed/sJdednLjpCI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
        <div class="video">
            <h1>Sniper Sword + AR Shotty</h1>
            <div class="vid2">
                <iframe width="100%" height="315" src="https://www.youtube.com/embed/Rf_PTEDcxp0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
        <div class="video2">
            <h1>Survival of the Fittest</h1>
            <div class="vid2">
                <iframe width="100%" height="315" src="https://www.youtube.com/embed/Hwlcs0_EmiY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
        <div class="video2">
            <h1>Killjoy Returns -Cold War PS4 Diamond Sniper Shotgun Gameplay</h1>
            <div class="vid2">
                <iframe width="100%" height="315" src="https://www.youtube.com/embed/NTTJL81zNOE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
        
        <div class="video2">
            <h1>No Montage Necessary</h1>
            <div class="vid2">
                <iframe width="100%" height="315" src="https://www.youtube.com/embed/bdzmfcdFGYc" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
        <br>
        <div class="video">
...
function chess(){
    ...
    <div class="video2">
    <h1>Gladiator Chess</h1>
    <iframe width="100%" height="315" src="https://www.youtube.com/embed/ItIQOybH5RA?si=EXCXG7PKYBI6L-FZ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    </div>

    

    <div class="video2">
    <h1>Pro Chess Video</h1>
    <iframe width="100%" height="315" src="https://www.youtube.com/embed/BZZlAmanEE8?si=tusfShGAGG0dgL46" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    </div>

    <div class="video">
    <h1>Puny Human Analysis</h1>
    <iframe width="100%" height="315" src="https://www.youtube.com/embed/HDKOZBLCUQw?si=jYP9lTkojXCNqEDH" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    </div>
    ...
    <div class="video2">
    <h1>2093</h1>
    <iframe width="100%" height="315" src="https://www.youtube.com/embed/Lap_tlvoXI4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
